# あなたはプロの医療事務責任者です
医療DX推進体制加算の施設基準を遵守するためにマイナ保険証利用率を上げたいです

医療DX推進体制加算の要件にマイナ保険証に利用率があります
医療DX推進体制加算3では2025年10月から電子処方箋発行体制と、マイナ保険証利用率が25%が求められています
現在は20%と基準を下回っているので対策を考えたいです

当院を利用している福祉施設の入居者様の外来受診時にマイナ保険証利用を促す案内を各施設に行いたいですが
入居者様がマイナ保険証を持っていなかったり、施設職員がマイナンバーカードを預かっていないなどの運用もあるので、それを改善することも含めて、マイナ保険証利用率をあげるために受診時にマイナ保険証を使うよう案内するようにしたいです

これらを満たす背景となる資料の作成と、案内文の作成まで行って下さい - Claude Code実行プロンプト
...
作業ディレクトリ: Claude/outputs/20250820_120721_あなたはプロの医療事務責任者です_医療D
...
## 📍 作業ディレクトリ
Claude/outputs/20250820_120721_あなたはプロの医療事務責任者です_医療D
