# pythonで業務自動化 - Claude Code実行プロンプト
...
作業ディレクトリ: Claude/outputs/20250805_222444_pythonで業務自動化
...
## 📍 作業ディレクトリ
Claude/outputs/20250805_222444_pythonで業務自動化

## 📁 参照ファイル
- プロンプトテンプレート: ../Claude/prompts/
- スタイルファイル: ../Claude/styles/

## ⚡ 効率的な実行のコツ
1. 一括実行プロンプトを使用すれば、全工程が自動化されます
2. 各ファイルは自動的に適切な場所に保存されます
3. スタイルファイルは ../Claude/styles/ から参照されます
